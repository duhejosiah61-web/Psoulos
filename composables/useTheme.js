...
export function useTheme() {
  // ==================== 字体相关 ====================
  const fonts = ref([
    { name: '默认字体1', displayName: '默认字体1', fontFamily: 'CustomFont1', url: '', fontId: 'font1' },
    { name: '默认字体2', displayName: '默认字体2', fontFamily: 'CustomFont2', url: '', fontId: 'font2' },
    { name: '默认字体3', displayName: '默认字体3', fontFamily: 'CustomFont3', url: '', fontId: 'font3' },
    { name: '默认字体4', displayName: '默认字体4', fontFamily: 'CustomFont4', url: '', fontId: 'font4' },
    { name: '默认字体5', displayName: '默认字体5', fontFamily: 'CustomFont5', url: '', fontId: 'font5' },
    { name: '默认字体6', displayName: '默认字体6', fontFamily: 'CustomFont6', url: '', fontId: 'font6' },
    { name: '默认字体7', displayName: '默认字体7', fontFamily: 'CustomFont7', url: '', fontId: 'font7' },
    { name: '默认字体8', displayName: '默认字体8', fontFamily: 'CustomFont8', url: '', fontId: 'font8' }
  ]);
